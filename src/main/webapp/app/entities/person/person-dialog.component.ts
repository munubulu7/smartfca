...
import { Salutation, SalutationService } from '../salutation';
...
export class PersonDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.salutationService.query()
            .subscribe((res: ResponseWrapper) => { this.salutations = res.json; }, (res: ResponseWrapper) => this.onError(res.json));
    }
    ...
    trackSalutationById(index: number, item: Salutation) {
        return item.id;
    }
}
