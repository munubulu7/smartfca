...
export class PostOfficeService {
    ...
    private resourceUrl = 'api/post-offices';

    constructor(private http: Http) { }

    create(postOffice: PostOffice): Observable<PostOffice> {
    ...
    update(postOffice: PostOffice): Observable<PostOffice> {
        const copy = this.convert(postOffice);
    ...
    find(id: number): Observable<PostOffice> {
